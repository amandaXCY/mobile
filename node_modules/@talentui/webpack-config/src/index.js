...
module.exports = (options = {}) => {
  ...
  let { port, host, friendly, moduleScope, mode, buildProd } = (global[
    globalObjectKey
  ] = o = require('./helpers/parse-config')(options));
  ...
  return {
    ...
    devServer: Object.assign(
      {
        ...
        quiet: friendly,
        disableHostCheck: !buildProd //当使用代理启动本地开发环境时，需要打开此配置项，让热更新的请求正常起来
      },
      options.devServer
    ),
    target: 'web',
    ...
    devtool: buildProd ? 'source-map' : 'cheap-source-map'
  };
};
